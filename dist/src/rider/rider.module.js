...
exports.RiderModule = RiderModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([rider_profile_entity_1.RiderProfile, trip_entity_1.Trip, job_offer_entity_1.JobOffer, notification_entity_1.Notification, user_entity_1.User]),
