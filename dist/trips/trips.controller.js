...
let TripsController = class TripsController {
    ...
    async verifyRiderCompat(user, tripId, body, req) {
        return this.apiResponse.success({
            code: 'TRIP_RIDER_VERIFIED',
            message: 'Rider verified',
            requestId: (0, request_id_1.getRequestId)(req),
    ...
    async cancel(user, tripId, body, req) {
        return this.apiResponse.success({
            ...
            requestId: (0, request_id_1.getRequestId)(req),
            data: await this.tripsService.cancel(user.driverId, tripId, body.reason ?? 'cancelled_by_driver', body.details, body.cancelledBy),
        });
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String, trips_dto_1.VerifyRiderDto, Object]),
    __metadata("design:returntype", Promise)
], TripsController.prototype, "verifyRiderCompat", null);
__decorate([
