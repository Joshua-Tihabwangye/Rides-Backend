...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: ['percent', 'flat'] }),
    __metadata("design:type", String)
], Promo.prototype, "discountType", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'decimal', precision: 10, scale: 2 }),
    __metadata("design:type", Number)
], Promo.prototype, "discountValue", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: ['draft', 'active', 'expired'], default: 'draft' }),
    __metadata("design:type", String)
